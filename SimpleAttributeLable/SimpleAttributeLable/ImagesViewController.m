...
- (void)viewDidLoad {
    ...
    AttributedLabel *label = [[AttributedLabel alloc] initWithFrame:CGRectZero];
    label.delegate = self;
    ...
    [label appendImage:[UIImage imageNamed:@"hot"] size:CGSizeMake(100, 100) margin:UIEdgeInsetsMake(10, 100, 10, 100) alignment:kImageVerticalAlignmentCenter];
...
//            [lable appendView:text];
    ...
    [label appendImage:[UIImage imageNamed:@"hot"] size:CGSizeMake(100, 100) margin:UIEdgeInsetsMake(10, 100, 10, 100) alignment:kImageVerticalAlignmentTop];

...
- (void)setTextFieldState:(UnderlineTextFieldState)textFieldState {
  _textFieldState = textFieldState;
  switch (textFieldState) {
    case UnderlineTextFieldStateNormal:
    self.userInteractionEnabled = YES;
    _stateImageView.image = nil;
    break;
    case UnderlineTextFieldStateCorrect:
    self.userInteractionEnabled = NO;
    _stateImageView.image = [UIImage imageNamed:@"icon_zt_dui"];
    break;
    case UnderlineTextFieldStateError:
    self.userInteractionEnabled = NO;
